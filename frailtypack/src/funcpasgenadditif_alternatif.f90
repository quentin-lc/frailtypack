...
!========================                  FUNCPA_WEIB (version GENERALISEE)                 ====================
    double precision function funcpasgenadditif_alternatif(b,np,id,thi,jd,thj,k0)
    ...
    ! call dblepr("Je suis dans la fonction funcpasgenadditif_alternatif", -1, 0.d0, 1)
	! ###############################################################################
    ...
    if (effet.eq.0) then
        do i=1,nsujet
            ...
            if ((res2(g(i)).ne.res2(g(i))).or.(abs(res2(g(i))).ge. 1.d30)) then
                funcpasgenadditif_alternatif=-1.d9
                goto 123
            end if
            ...
            RisqCumul(i) = (t1(i)/etaT(stra(i)))**betaT(stra(i)) + t1(i)*vet
...
!     i indice les sujets
        do i=1,nsujet
            ...
            res1(g(i)) = res1(g(i)) + (t1(i)/etaT(stra(i)))**betaT(stra(i)) + t1(i)*vet
...
! modification pour nouvelle vraisemblance / troncature:
            !en plus strates A.Lafourcade 05/2014
            res3(g(i)) = res3(g(i)) + (t0(i)/etaT(stra(i)))**betaT(stra(i)) + t0(i)*vet
...
!    Changed JRG 25 May 05
    ...
    funcpasgenadditif_alternatif = res
...
123     continue
    ...
    end function funcpasgenadditif_alternatif
