...
!========================          FUNCPAJ_CPM         ====================
    double precision function funcpajgen_tps(b,np,id,thi,jd,thj,k0)
    ...
    double precision,external::risqindivrecPH,risqindivdcPH
    double precision,external::risqindivrecAH_initial,risqindivrecAH_positif
    double precision,external::risqindivdcAH_initial,risqindivdcAH_positif
    double precision,external::risqindivrecAH_alternatif,risqindivdcAH_alternatif
...
!cccccccccccccccccccccc
        if (c(i).eq.1) then
            if(famillerisquerec .eq. 0) then
                res2(g(i)) = res2(g(i)) + dlog(risqindivrecPH(t1(i),i,bh,np))
            else if (famillerisquerec .eq. 3) then
                res2(g(i)) = res2(g(i)) + dlog(risqindivrecAH_positif(t1(i),i,bh,np))
            else if (famillerisquerec .eq. 4) then
                res2(g(i)) = res2(g(i)) + dlog(risqindivrecAH_alternatif(t1(i),i,bh,np))
            endif
        endif

        if ((res2(g(i)).ne.res2(g(i))).or.(abs(res2(g(i))).ge. 1.d30)) then
            !print*,"here",res2(g(i)),risqindivrecPH(t1(i),i,bh,np)
            funcpajgen_tps=-1.d9
            goto 123
        end if
...
!cccccccccccccccccccccc
        if(famillerisquerec .eq. 0) then
            call integration(risqindivrecPH,0.d0,t1(i),result,abserr,resabs,resasc,i,bh,np)
            res1(g(i)) = res1(g(i)) + result
        else if (famillerisquerec .eq. 3) then
            call integration(risqindivrecAH_positif,0.d0,t1(i),result,abserr,resabs,resasc,i,bh,np)
            res1(g(i)) = res1(g(i)) + result
        else if (famillerisquerec .eq. 4) then
            call integration(risqindivrecAH_alternatif,0.d0,t1(i),result,abserr,resabs,resasc,i,bh,np)
            res1(g(i)) = res1(g(i)) + result
        endif
...
!cccccccccccccccccc
        if(famillerisquerec .eq. 0) then
            call integration(risqindivrecPH,0.d0,t0(i),result3,abserr,resabs,resasc,i,bh,np)
            res3(g(i)) = res3(g(i)) + result3
        else if (famillerisquerec .eq. 3) then
            call integration(risqindivrecAH_positif,0.d0,t0(i),result3,abserr,resabs,resasc,i,bh,np)
            res3(g(i)) = res3(g(i)) + result3
        else if (famillerisquerec .eq. 4) then
            call integration(risqindivrecAH_alternatif,0.d0,t0(i),result3,abserr,resabs,resasc,i,bh,np)
            res3(g(i)) = res3(g(i)) + result3
        endif
...
!cccccccccccccccccc
        if (cdc(k).eq.1) then
            if(famillerisquedc .eq. 0) then
                res2dc(k) = dlog(risqindivdcPH(t1dc(k),k,bh,np))
            else if (famillerisquedc .eq. 3) then
                res2dc(k) = dlog(risqindivdcAH_positif(t1dc(k),k,bh,np))
            else if (famillerisquedc .eq. 4) then
                res2dc(k) = dlog(risqindivdcAH_alternatif(t1dc(k),k,bh,np))
            endif
        endif
...
!cccccccccccccccccc
        if(famillerisquedc .eq. 0) then
            call integration(risqindivdcPH,t0dc(k),t1dc(k),resultdc,abserr,resabs,resasc,k,bh,np)
            aux1(k) = resultdc
        else if (famillerisquedc .eq. 3) then
            call integration(risqindivdcAH_positif,t0dc(k),t1dc(k),resultdc,abserr,resabs,resasc,k,bh,np)
            aux1(k) = resultdc
        else if (famillerisquedc .eq. 4) then
            call integration(risqindivdcAH_alternatif,t0dc(k),t1dc(k),resultdc,abserr,resabs,resasc,k,bh,np)
            aux1(k) = resultdc
        endif
...
!====================================================================
    double precision function risqindivrecPH(tps,i,bh,np)
    ...
    risqindivrecPH = bbb*vet

    return

    end function risqindivrecPH
!====================================================================
!====================================================================
    double precision function risqindivdcPH(tps,i,bh,np)
    ...
    risqindivdcPH = bbb*vet2

    return

    end function risqindivdcPH
!====================================================================
...
!====================================================================
    double precision function risqindivrecAH_initial(tps,i,bh,np)
    ...
    risqindivrecAH_initial = bbb+dlog(vet)

    return

    end function risqindivrecAH_initial
!====================================================================
!====================================================================
    double precision function risqindivrecAH_positif(tps,i,bh,np)
    ...
    risqindivrecAH_positif = bbb+dlog(vet)
    if (risqindivrecAH_positif.le.0.d0) then
        risqindivrecAH_positif = 1d-16
    endif

    return

    end function risqindivrecAH_positif
!====================================================================
...
!====================================================================
    double precision function risqindivdcAH_initial(tps,i,bh,np)
    ...
    risqindivdcAH_initial = bbb+dlog(vet2)

    return

    end function risqindivdcAH_initial
!====================================================================
!====================================================================
    double precision function risqindivdcAH_positif(tps,i,bh,np)
    ...
    risqindivdcAH_positif = bbb+dlog(vet2)
    if (risqindivdcAH_positif.le.0.d0) then
        risqindivdcAH_positif = 1d-16
    endif

    return

    end function risqindivdcAH_positif
!====================================================================
...
!====================================================================
    double precision function risqindivrecAH_alternatif(tps,i,bh,np)
    ...
    risqindivrecAH_alternatif = bbb+vet

    return

    end function risqindivrecAH_alternatif
!====================================================================

!====================================================================
    double precision function risqindivdcAH_alternatif(tps,i,bh,np)
    ...
    risqindivdcAH_alternatif = bbb+vet2

    return

    end function risqindivdcAH_alternatif
!====================================================================
