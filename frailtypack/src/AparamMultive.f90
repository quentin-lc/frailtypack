    ...
    module parametersmultiv
        ...
        integer,save::constraintfrailty
    ...
    module comonmultiv
        ...
        double precision,dimension(:),allocatable,save::ghNodes,ghWeights
        integer,save::ghPoints,typeJoint,event2_ind,terminal2_ind
        ...
        t0meta,t1meta
        integer,dimension(:),allocatable,save:: c,cmeta,cdc,cdc2
        ...
        integer,save::nsujet,nva,nva1,nva2,nva3,nva4,ndate,ndatedc,nst,ndatemeta,&
        nsujetmeta
        ...
        double precision,dimension(:,:),allocatable,save::vedc,vedc2
        !*****dace3
        ...
        integer,dimension(:),allocatable,save::vectn ! removed by LE
        integer,save::vectn2 ! added by LE
        !*****groupe
        ...
        double precision, dimension(:),allocatable,save::mm3meta,mm2meta,&
        mm1meta,mmmeta,im3meta,im2meta,im1meta,immeta
    
        double precision,dimension(:),allocatable,save::m3m3b,m2m2b,m1m1b,&
        mmmb,m3m2b
        ...
        double precision,dimension(:),allocatable,save::m3m3d,m2m2d,m1m1d,mmmd,m3m2d
        
        double precision,dimension(:),allocatable,save::m3m1d,m3md,m2m1d,m2md,m1md,mid
    
        !************************************************************
        !AD: add for death
        double precision, dimension(:),allocatable,save::mm3dc,mm2dc,mm1dc,&
        ...
        !****  theta/alpha
        double precision,save::theta,theta2,rho,alpha,eta,alpha1,alpha2 !en exposant pour la frailty deces
        ...
        integer,save:: nbrecu,nbdeces,nbrecumeta,nbinterv,nbintervR,nbintervDC,nbintervM
        ...
        !Weib
        double precision,save::etaR,etaD,etaD2,betaR,betaD,etaM,betaM,betaD2
        integer,save::indic_tronc,indic_frail
        
        double precision,dimension(:),allocatable,save::vaxdc2
