...
!--entête pour fortran
    subroutine jointgen(nsujet0,ngrp,strAux,lignedc0,nz0,axT,tt00,tt10,ic0,groupe0,groupe00,fam0 & ! removed nstRecAux, combined with ngrp
...
!    ,initialisation,nn,Bshared ! enleve pour le moment
    ,linearpredG,typeJoint0,intcens0,indices0,ttU0, ordretmp, &
    init_and_logN, & !initialize,logNormal0 
    paratps,filtretps0,BetaTpsMat,BetaTpsMatDc, EPS, nbgauss, &
    familyrisk)
...
!AD: add for new marq
    ...
    double precision,external::funcpajsplines,funcpajsplines_fam, funcpajcpm, funcpajweib_fam,funcpajsplinesindiv !IJ
    double precision,external::funcpajweib, funcpajgenparam
    ...
    double precision,external::funcpaj_tps,funcpaG_tps,funcpajgen_tps
...
!    double precision,dimension(nn)::Bshared
    ...
    integer,dimension(2),intent(in)::init_and_logN
    integer,dimension(2)::familyrisk
    integer::initialize
    initialize = init_and_logN(1)
    famillerisque = familyrisk
    ...
    logNormal = init_and_logN(2) !logNormal0
    intcens = intcens0
