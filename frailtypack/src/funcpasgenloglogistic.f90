...
!========================                  FUNCPA_LOGLOGISTIC (version GENERALISEE)                 ====================
    double precision function funcpasgenloglogistic(b,np,id,thi,jd,thj,k0)
    ...
    ! call dblepr("Je suis dans la fonction funcpasgenloglogistic", -1, 0.d0, 1)
	! ###############################################################################
...
123     continue
    ...
    end function funcpasgenloglogistic
